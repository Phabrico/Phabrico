...
{
    /// <summary>
    /// Represents a menuitem in the Phriction screen which allows you to validate a Phriction document and all its underlying documents
    /// </summary>
    [PluginType(Usage = PluginTypeAttribute.UsageType.Navigator)]
    public class JSPaintImageEditor : PluginBase
    {
        /// <summary>
        ...
        {
            return Locale.TranslateText("PluginName.JSPaintImageEditor", locale);
        }
        ...
        /// <summary>
        /// Terminates the JSPaintImageEditor plugin
        /// </summary>
