...
namespace Phabrico.Parsers.Remarkup.Rules
{
    ...
    public class RuleFormattingBold : RemarkupRule
    {
        /// <summary>
        ...
        public override bool ToHTML(Storage.Database database, Browser browser, string url, ref string remarkup, out string html)
        {
            ...
            html = string.Format("<strong>{0}</strong>", Engine.ToHTML(this, database, browser, url, match.Groups[1].Value, out remarkupParserOutput, false));
